...
* fix(planning): corrects typo in svg (`#9814 <https://github.com/rej55/autoware.universe/issues/9814>`_)
* fix(planning): corrects typos (`#9840 <https://github.com/rej55/autoware.universe/issues/9840>`_)
...
* refactor(behavior_velocity_planner_common): add behavior_velocity_rtc_interface and move RTC-related implementation (`#9799 <https://github.com/rej55/autoware.universe/issues/9799>`_)
  ...
  * fix
  ---------
  Co-authored-by: Mamoru Sobue <mamoru.sobue@tier4.jp>
* Contributors: Atto Armoo, Mamoru Sobue, Satoshi OTA, Takayuki Murooka, github-actions
