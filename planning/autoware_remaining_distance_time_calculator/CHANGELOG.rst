...
* feat(remaining_distance_time_calculator): integrate generate_parameter_library (`#8826 <https://github.com/rej55/autoware.universe/issues/8826>`_)
  ...
  * change scope of compile option to private
  ---------
* feat(remaining_distance_time_calculator): skip calculation during parking (`#9013 <https://github.com/rej55/autoware.universe/issues/9013>`_)
* Contributors: Ismet Atabay, Mitsuhiro Sakamoto, github-actions
