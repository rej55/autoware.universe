...
* feat: tier4_debug_msgs changed to autoware_internal_debug_msgs in fil… (`#9902 <https://github.com/rej55/autoware.universe/issues/9902>`_)
...
* test(external_velocity_limit_selector): add node test (`#8944 <https://github.com/rej55/autoware.universe/issues/8944>`_)
  add node smoke test
* Contributors: Maxime CLEMENT, Vishal Chauhan, github-actions
