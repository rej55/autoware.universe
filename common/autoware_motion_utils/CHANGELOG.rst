...
* chore(planning): move package directory for planning factor interface (`#9948 <https://github.com/rej55/autoware.universe/issues/9948>`_)
  ...
  * chore(motion_utils): remove factor interface
  ---------
* feat(motion_utils): add detail and pass type to VirtualWall (`#9940 <https://github.com/rej55/autoware.universe/issues/9940>`_)
* fix(autoware_motion_utils): remove clang compiler error (`#9713 <https://github.com/rej55/autoware.universe/issues/9713>`_)
* feat(motion_utils): add planning factor interface (`#9676 <https://github.com/rej55/autoware.universe/issues/9676>`_)
  * feat(motion_utils): add planning factor interface
  * fix: use extern template
  * fix: define function in header
  ---------
* Contributors: Mamoru Sobue, Ryuta Kambe, Satoshi OTA, github-actions
