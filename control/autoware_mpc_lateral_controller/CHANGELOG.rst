...
* feat: tier4_debug_msgs changed to autoware_internal_debug_msgs in fil… (`#9846 <https://github.com/rej55/autoware.universe/issues/9846>`_)
...
* chore(autoware_mpc_lateral_controller): fix formula description in vehicle_model_bicycle_kinematics.hpp (`#8971 <https://github.com/rej55/autoware.universe/issues/8971>`_)
  fix formula description in vehicle_model_bicycle_kinematics.hpp
* fix(mpc_lateral_controller): prevent unstable steering command while stopped (`#9690 <https://github.com/rej55/autoware.universe/issues/9690>`_)
  ...
  * add comment to implementation
  ---------
* feat(mpc_lateral_controller): remove trans/rot deviation validation since the control_validator has the same feature (`#9684 <https://github.com/rej55/autoware.universe/issues/9684>`_)
* docs: modified minor sign error (`#8140 <https://github.com/rej55/autoware.universe/issues/8140>`_)
* Contributors: Autumn60, Takayuki Murooka, Vishal Chauhan, Yuki Kimura, github-actions, mkquda
