...
* chore(autoware_traffic_light_classifier): modify docs (`#9819 <https://github.com/rej55/autoware.universe/issues/9819>`_)
  * modify docs
...
* refactor(autoware_tensorrt_common): multi-TensorRT compatibility & tensorrt_common as unified lib for all perception components (`#9762 <https://github.com/rej55/autoware.universe/issues/9762>`_)
  ...
  * style(pre-commit): autofix
  ...
  Co-authored-by: Kenzo Lobos Tsunekawa <kenzo.lobos@tier4.jp>
  Co-authored-by: Kotaro Uetake <60615504+ktro2828@users.noreply.github.com>
* Contributors: Amadeusz Szymko, Masato Saeki, github-actions
...
* fix: fix ticket links in CHANGELOG.rst (`#9588 <https://github.com/autowarefoundation/autoware.universe/issues/9588>`_)
* fix(autoware_traffic_light_classifier): fix clang-diagnostic-delete-abstract-non-virtual-dtor (`#9497 <https://github.com/autowarefoundation/autoware.universe/issues/9497>`_)
