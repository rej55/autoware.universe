...
* fix(autoware_raindrop_cluster_filter): fix clang-diagnostic-unused-private-field (`#9496 <https://github.com/autowarefoundation/autoware.universe/issues/9496>`_)
* 0.39.0
* update changelog
